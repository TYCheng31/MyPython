...
with open("aggregated_output.csv", "w", newline="") as csvfile:
...
users = [result["first_name"] for result in final_aggregated_results_sorted]
scores = [result["total_score"] for result in final_aggregated_results_sorted]

plt.figure(figsize=(10, 6))
plt.bar(users, scores, color='green')
plt.xlabel('Users')
